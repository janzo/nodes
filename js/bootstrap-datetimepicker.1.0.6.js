...
(function ($) {
    ...
    DateTimePicker.prototype = {
        ...
        init: function (element, options) {
            ...
            // parametri per aggiustare posizione calendario rispetto al bottone
            this.extraTop = options.extraTop ? options.extraTop : 0;
            this.extraLeft = options.extraLeft ? options.extraLeft : 0;            
            ...
            if (!this.format) {
                ...
                if (!this.format) this.format = (this.pickDate ? 'dd-MM-yyyy' : '')
...
//             alert(this.extraTop);
//             alert(this.extraLeft);
//             alert(offset.top);
//             alert(offset.left);
            this.widget.css({
                position: position,
                top: offset.top + this.extraTop,
                left: offset.left + this.extraLeft,
                right: offset.right
            });
        },
	...
	this.setStartDate_old = function (date) {
            if (date instanceof Date) {
                this.startDate = date;
            } else if (typeof date === 'string') {
                this.startDate = new UTCDate(date);
